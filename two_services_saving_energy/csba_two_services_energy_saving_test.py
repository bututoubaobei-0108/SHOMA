...
MultiService.multiServiceModel.load_state_dict(torch.load('data/lstm/MultiService_lstm_v1_6_temp_air_cbshomma_even_new.pth'))
MultiService.targetMultiServiceModel.load_state_dict(torch.load('data/lstm/MultiService_lstm_v1_6_temp_air_cbshomma_even_new.pth'))
...
np.save(f'data/lstm/totalAcc_lstm_v1_temp_air_cbshomma_even_new_100.npy',totalAcc) 
        
np.save(f'data/lstm/replayMemory_temp_lstm_v1_temp_air_cbshomma_even_new_100.npy',tempService.replayMemory)
np.save(f'data/lstm/replayMemory_air_lstm_v1_temp_air_cbshomma_even_new_100.npy',airService.replayMemory)
