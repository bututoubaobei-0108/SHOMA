...
tempService.tempServiceModel.load_state_dict(torch.load('./../../data/tempService_lstm_v1_temp_air_eishomma_2.0_even.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('./../../data/tempService_lstm_v1_temp_air_eishomma_2.0_even.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('./../../data/airService_lstm_v1_temp_air_eishomma_2.0_even.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('./../../data/airService_lstm_v1_temp_air_eishomma_2.0_even.pth'))
...
# %%   
    ...
    for step in range(0,steps):
        ...
        two_reward_t=temp_reward_t+air_reward_t
    ...
    #     torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v1_{1+int(epoch/200)}_temp_air_eishomma_2.0_even.pth')
    #     torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v1_{1+int(epoch/200)}_temp_air_eishomma_2.0_even.pth')

    #     np.save(f'data/lstm/totalEpochRewards_lstm_v1_{1+int(epoch/200)}_temp_air_eishomma_2.0_even.npy',totalEpochRewards)
        

# torch.save(lightService.lightServiceModel.state_dict(),'data/lstm/lightService_lstm_v1_eishomma_even.pth')
# torch.save(tempService.tempServiceModel.state_dict(),'data/lstm/tempService_lstm_v1_temp_air_eishomma_2.0_even.pth')
# torch.save(airService.airServiceModel.state_dict(),'data/lstm/airService_lstm_v1_temp_air_eishomma_2.0_even.pth')

# np.save(f'data/lstm/totalEpochRewards_lstm_v1_temp_air_eishomma_2.0_even.npy',totalEpochRewards)

        
        

print(f'100 acc: {np.average(totalAcc,axis=0)}')  
np.save(f'./../../data/totalAcc_lstm_v1_temp_air_eishomma_2.0_even_100_2.npy',totalAcc) 
        
np.save(f'./../../data/replayMemory_temp_lstm_v1_temp_air_eishomma_2.0_even_100_2.npy',tempService.replayMemory)
np.save(f'./../../data/replayMemory_air_lstm_v1_temp_air_eishomma_2.0_even_100_2.npy',airService.replayMemory)
    
        
# tempR=np.load(f'data/lstm/replayMemory_temp_lstm_v1_temp_air_eishomma_2.0_even_100.npy',allow_pickle=True)
# airR=np.load(f'data/lstm/replayMemory_air_lstm_v1_temp_air_eishomma_2.0_even_100.npy',allow_pickle=True)
