...
# from LSTM_LIGHT_Service_CELL_32 import *
...
tempService.tempServiceModel.load_state_dict(torch.load('./../../data/tempService_lstm_v1_cabshomma_even.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('./../../data/tempService_lstm_v1_cabshomma_even.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('./../../data/airService_lstm_v1_cabshomma_even.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('./../../data/airService_lstm_v1_cabshomma_even.pth'))

commonService=CommonService_cell()
commonService.commonServiceModel.load_state_dict(torch.load('./../../data/commonService_lstm_v1_cabshomma_even.pth'))
commonService.targetCommonServiceModel.load_state_dict(torch.load('./../../data/commonService_lstm_v1_cabshomma_even.pth'))
...
# %%   
    ...
    #     # torch.save(lightService.lightServiceModel.state_dict(),f'data/lstm/lightService_lstm_v1_{1+int(epoch/100)}_mlt_32.pth')
    #     torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v1_{1+int(epoch/200)}_cabshomma_even.pth')
    #     torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v1_{1+int(epoch/200)}_cabshomma_even.pth')
    #     torch.save(commonService.commonServiceModel.state_dict(), f'data/lstm/commonService_lstm_v1_{1+int(epoch/200)}_cabshomma_even.pth')
    #     np.save(f'data/lstm/totalEpochRewards_lstm_v1_{1+int(epoch/200)}_cabshomma_even.npy',totalEpochRewards)
        

# # torch.save(lightService.lightServiceModel.state_dict(),'data/lstm/lightService_lstm_v1_cabshomma_even.pth')
# torch.save(tempService.tempServiceModel.state_dict(),'data/lstm/tempService_lstm_v1_cabshomma_even.pth')
# torch.save(airService.airServiceModel.state_dict(),'data/lstm/airService_lstm_v1_cabshomma_even.pth')
# torch.save(commonService.commonServiceModel.state_dict(), f'data/lstm/commonService_lstm_v1_cabshomma_even.pth')
# np.save(f'data/lstm/totalEpochRewards_lstm_v1_cabshomma_even.npy',totalEpochRewards)


print(f'100 acc: {np.average(totalAcc,axis=0)}')  
np.save(f'./../../data/totalAcc_lstm_v1_cabshomma_even_100.npy',totalAcc) 
        
np.save(f'./../../data/replayMemory_temp_lstm_v1_cabshomma_even_100.npy',tempService.replayMemory)
np.save(f'./../../data/replayMemory_air_lstm_v1_cabshomma_even_100.npy',airService.replayMemory)
