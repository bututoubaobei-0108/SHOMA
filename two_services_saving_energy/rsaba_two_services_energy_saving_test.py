...
tempService.tempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_temp_air_eishomma_1.0_even_c.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_temp_air_eishomma_1.0_even_c.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_temp_air_eishomma_1.0_even_c.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_temp_air_eishomma_1.0_even_c.pth'))
...
np.save(f'data/lstm/totalAcc_lstm_v1_temp_air_eishomma_1.0_even_c_100.npy',totalAcc) 
        
np.save(f'data/lstm/replayMemory_temp_lstm_v1_temp_air_eishomma_1.0_even_c_100.npy',tempService.replayMemory)
np.save(f'data/lstm/replayMemory_air_lstm_v1_temp_air_eishomma_1.0_even_c_100.npy',airService.replayMemory)
