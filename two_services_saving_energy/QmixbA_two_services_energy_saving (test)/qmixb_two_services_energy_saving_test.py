...
qmix_sho_agent.temp_service.agents.load_state_dict(torch.load('./../../data/tempService_lstm_v1_temp_air_qmixshomma_3.pth'))
qmix_sho_agent.air_service.agents.load_state_dict(torch.load('./../../data/airService_lstm_v1_temp_air_qmixshomma_3.pth'))
qmix_sho_agent.qmixer.load_state_dict(torch.load('./../../data/qmixer_lstm_v1_temp_air_qmixshomma_3.pth'))
...
np.save(f'./../../data/totalAcc_lstm_v1_temp_air_qmixshomma_3_100.npy',totalAcc) 
        
np.save(f'./../../data/replayMemory_temp_lstm_v1_temp_air_qmixshomma_3_100.npy',tempService.replayMemory)
np.save(f'./../../data/replayMemory_air_lstm_v1_temp_air_qmixshomma_3_100.npy',airService.replayMemory)
