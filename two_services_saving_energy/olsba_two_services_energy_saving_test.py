...
MultiService.multiServiceModel.load_state_dict(torch.load('data/lstm/multiService_lstm_v1_3_temp_air_olbshomma_even_new.pth'))
MultiService.targetMultiServiceModel.load_state_dict(torch.load('data/lstm/multiService_lstm_v1_3_temp_air_olbshomma_even_new.pth'))
...
np.save(f'data/lstm/totalAcc_multiService_totalEpochRewards_lstm_v1_temp_air_olbshomma_even_new_100.npy',totalAcc) 
        
np.save(f'data/lstm/MultiService_lstm_v1_temp_air_olbshomma_even_new_100.npy',MultiService.replayMemory)
