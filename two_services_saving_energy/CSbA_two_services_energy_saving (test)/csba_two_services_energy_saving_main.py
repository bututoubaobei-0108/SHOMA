...
# %%   
    ...
    if epoch%50==0 and epoch!=0:      
        torch.save(MultiService.multiServiceModel.state_dict(),f'./../../data/MultiService_lstm_v1_{1+int(epoch/50)}_temp_air_cbshomma_even_new.pth')
        np.save(f'./../../data/multiService_totalEpochRewards_lstm_v1_{1+int(epoch/50)}_temp_air_cbshomma_even_new.npy',totalEpochRewards)
        np.save(f'./../../data/multiService_totalAcc_lstm_v1_{1+int(epoch/50)}_temp_air_cbshomma_even_new.npy',totalAcc)
        

torch.save(MultiService.multiServiceModel.state_dict(),'./../../data/MultiService_lstm_v1_temp_air_cbshomma_even_new.pth')

np.save(f'./../../data/multiService_totalEpochRewards_lstm_v1_temp_air_cbshomma_even_new.npy',totalEpochRewards)
np.save(f'./../../data/multiService_totalAcc_lstm_v1_temp_air_cbshomma_even_new.npy',totalAcc)
