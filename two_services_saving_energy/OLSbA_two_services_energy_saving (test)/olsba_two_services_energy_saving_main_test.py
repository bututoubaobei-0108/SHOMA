...
MultiService.multiServiceModel.load_state_dict(torch.load('./../../data/multiService_lstm_v1_3_temp_air_olbshomma_even_new.pth'))
MultiService.targetMultiServiceModel.load_state_dict(torch.load('./../../data/multiService_lstm_v1_3_temp_air_olbshomma_even_new.pth'))
...
#         torch.save(MultiService.multiServiceModel.state_dict(),f'data/lstm/multiService_lstm_v1_{1+int(epoch/50)}_temp_air_olbshomma_even_new.pth')
#         np.save(f'data/lstm/multiService_totalAcc_lstm_v1_{1+int(epoch/50)}_temp_air_olbshomma_even_new.npy',totalAcc)
        

# torch.save(MultiService.multiServiceModel.state_dict(),'data/lstm/multiService_lstm_v1_temp_air_olbshomma_even_new.pth')

# np.save(f'data/lstm/multiService_totalEpochRewards_lstm_v1_temp_air_olbshomma_even_new.npy',totalEpochRewards)
# np.save(f'data/lstm/multiService_totalAcc_lstm_v1_temp_air_olbshomma_even_new.npy',totalAcc)

        
        
print(f'100 acc: {np.average(totalAcc,axis=0)}')  
np.save(f'./../../data/totalAcc_multiService_totalEpochRewards_lstm_v1_temp_air_olbshomma_even_new_100.npy',totalAcc) 
        
np.save(f'./../../data/MultiService_lstm_v1_temp_air_olbshomma_even_new_100.npy',MultiService.replayMemory)
# np.save(f'data/lstm/replayMemory_air_lstm_v1_temp_air_cbshomma_even_100.npy',airService.replayMemory)
