...
# lightService=LightService_cell()
lightService.lightServiceModel.load_state_dict(torch.load('./../../data/lightService_lstm_v1_eishomma_1.0_even.pth'))
lightService.targetLightServiceModel.load_state_dict(torch.load('./../../data/lightService_lstm_v1_eishomma_1.0_even.pth'))

tempService=TempService_cell()
tempService.tempServiceModel.load_state_dict(torch.load('./../../data/tempService_lstm_v1_eishomma_1.0_even.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('./../../data/tempService_lstm_v1_eishomma_1.0_even.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('./../../data/airService_lstm_v1_eishomma_1.0_even.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('./../../data/airService_lstm_v1_eishomma_1.0_even.pth'))
...
#         torch.save(lightService.lightServiceModel.state_dict(),f'data/lstm/lightService_lstm_v1_{1+int(epoch/100)}_eishomma_1.0_even.pth')
#         torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v1_{1+int(epoch/200)}_eishomma_1.0_even.pth')
#         torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v1_{1+int(epoch/200)}_eishomma_1.0_even.pth')
#         np.save(f'data/lstm/totalEpochRewards_lstm_v1_{1+int(epoch/200)}_eishomma_1.0_even.npy',totalEpochRewards)
        

# torch.save(lightService.lightServiceModel.state_dict(),'data/lstm/lightService_lstm_v1_eishomma_1.0_even.pth')
# torch.save(tempService.tempServiceModel.state_dict(),'data/lstm/tempService_lstm_v1_eishomma_1.0_even.pth')
# torch.save(airService.airServiceModel.state_dict(),'data/lstm/airService_lstm_v1_eishomma_1.0_even.pth')
# np.save(f'data/lstm/totalEpochRewards_lstm_v1_eishomma_1.0_even.npy',totalEpochRewards)

        
print(f'100 acc: {np.average(totalAcc,axis=0)}')

np.save(f'./../../data/totalAcc_lstm_v1_eishomma_1.0_even_100.npy',totalAcc)
np.save(f'./../../data/replayMemory_light_lstm_v1_eishomma_1.0_even_100.npy',lightService.replayMemory)
np.save(f'./../../data/replayMemory_temp_lstm_v1_eishomma_1.0_even_100.npy',tempService.replayMemory)
np.save(f'./../../data/replayMemory_air_lstm_v1_eishomma_1.0_even_100.npy',airService.replayMemory)
