...
# lightService.lightServiceModel.load_state_dict(torch.load('data/lstm/lightService_lstm_v1_4_eishomma_2.0_even.pth'))
# lightService.targetLightServiceModel.load_state_dict(torch.load('data/lstm/lightService_lstm_v1_4_eishomma_2.0_even.pth'))

tempService=TempService_cell()
# tempService.tempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_4_eishomma_2.0_even.pth'))
# tempService.targetTempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_4_eishomma_2.0_even.pth'))

airService=AirService_cell()
# airService.airServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_4_eishomma_2.0_even.pth'))
# airService.targetAirServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_4_eishomma_2.0_even.pth'))
...
# %%   
    ...
    if epoch%50==0 and epoch!=0:      
        torch.save(lightService.lightServiceModel.state_dict(),f'./../../data/lightService_lstm_v1_{1+4+int(epoch/50)}_eishomma_2.0_even.pth')
        torch.save(tempService.tempServiceModel.state_dict(),f'./../../data/tempService_lstm_v1_{1+4+int(epoch/50)}_eishomma_2.0_even.pth')
        torch.save(airService.airServiceModel.state_dict(),f'./../../data/airService_lstm_v1_{1+4+int(epoch/50)}_eishomma_2.0_even.pth')

        np.save(f'./../../data/totalEpochRewards_lstm_v1_{1+4+int(epoch/50)}_eishomma_2.0_even.npy',totalEpochRewards)
        np.save(f'./../../data/totalAcc_lstm_v1_{1+4+int(epoch/50)}_eishomma_2.0_even.npy',totalAcc)
        

torch.save(lightService.lightServiceModel.state_dict(),'./../../data/lightService_lstm_v1_eishomma_2.0_even.pth')
torch.save(tempService.tempServiceModel.state_dict(),'./../../data/tempService_lstm_v1_eishomma_2.0_even.pth')
torch.save(airService.airServiceModel.state_dict(),'./../../data/airService_lstm_v1_eishomma_2.0_even.pth')

np.save(f'./../../data/totalEpochRewards_lstm_v1_eishomma_2.0_even.npy',totalEpochRewards)
np.save(f'./../../data/totalAcc_lstm_v1_eishomma_2.0_even.npy',totalAcc)
