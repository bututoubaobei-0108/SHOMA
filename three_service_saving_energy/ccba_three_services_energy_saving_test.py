...
lightService.lightServiceModel.load_state_dict(torch.load('data/lstm/lightService_lstm_v1_4_multi_cabshomma_even.pth'))
lightService.targetLightServiceModel.load_state_dict(torch.load('data/lstm/lightService_lstm_v1_4_multi_cabshomma_even.pth'))

tempService=TempService_cell()
tempService.tempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_4_multi_cabshomma_even.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_4_multi_cabshomma_even.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_4_multi_cabshomma_even.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_4_multi_cabshomma_even.pth'))

commonService=CommonService_cell()
commonService.commonServiceModel.load_state_dict(torch.load('data/lstm/commonService_lstm_v1_4_multi_cabshomma_even.pth'))
commonService.targetCommonServiceModel.load_state_dict(torch.load('data/lstm/commonService_lstm_v1_4_multi_cabshomma_even.pth'))
...
np.save(f'data/lstm/totalAcc_lstm_v1_multi_cabshomma_even_100.npy',totalAcc)
np.save(f'data/lstm/replayMemory_light_lstm_v1_multi_cabshomma_even_100.npy',lightService.replayMemory)
np.save(f'data/lstm/replayMemory_temp_lstm_v1_multi_cabshomma_even_100.npy',tempService.replayMemory)
np.save(f'data/lstm/replayMemory_air_lstm_v1_multi_cabshomma_even_100.npy',airService.replayMemory)
