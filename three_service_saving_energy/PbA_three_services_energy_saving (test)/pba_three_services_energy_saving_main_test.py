...
lightService.lightServiceModel.load_state_dict(torch.load('./../../data/lightService_lstm_v1_25_mlt_pbshomma_even.pth'))
lightService.targetLightServiceModel.load_state_dict(torch.load('./../../data/lightService_lstm_v1_25_mlt_pbshomma_even.pth'))

tempService=TempService_cell()
tempService.tempServiceModel.load_state_dict(torch.load('./../../data/tempService_lstm_v1_25_mlt_pbshomma_even.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('./../../data/tempService_lstm_v1_25_mlt_pbshomma_even.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('./../../data/airService_lstm_v1_25_mlt_pbshomma_even.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('./../../data/airService_lstm_v1_25_mlt_pbshomma_even.pth'))

cur_calculator=CalculationPriorities_cell(num_inputs=X_US.shape[1]+1+1+1,num_outputs=3)
cur_calculator.calPrioModel.load_state_dict(torch.load('./../../data/cur_calculator_v1_25_mlt_pbshomma_even.pth'))
cur_calculator.targetCalPrioModel.load_state_dict(torch.load('./../../data/cur_calculator_v1_25_mlt_pbshomma_even.pth'))

win_calculator=CalculationPriorities_cell(num_inputs=X_US.shape[1]+1+1,num_outputs=2)
win_calculator.calPrioModel.load_state_dict(torch.load('./../../data/win_calculator_v1_25_mlt_pbshomma_even.pth'))
win_calculator.targetCalPrioModel.load_state_dict(torch.load('./../../data/win_calculator_v1_25_mlt_pbshomma_even.pth'))

t_calculator=CalculationPriorities_cell(num_inputs=X_US.shape[1]+1+1,num_outputs=2)
t_calculator.calPrioModel.load_state_dict(torch.load('./../../data/t_calculator_v1_25_mlt_pbshomma_even.pth'))
t_calculator.targetCalPrioModel.load_state_dict(torch.load('./../../data/t_calculator_v1_25_mlt_pbshomma_even.pth'))
...
#         torch.save(lightService.lightServiceModel.state_dict(),f'data/lstm/lightService_lstm_v1_{1+int(epoch/50)}_mlt_pbshomma_even.pth')
#         torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v1_{1+int(epoch/50)}_mlt_pbshomma_even.pth')
#         torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v1_{1+int(epoch/50)}_mlt_pbshomma_even.pth')

#         torch.save(cur_calculator.calPrioModel.state_dict(),f'data/lstm/cur_calculator_v1_{1+int(epoch/50)}_mlt_pbshomma_even.pth')
#         torch.save(win_calculator.calPrioModel.state_dict(),f'data/lstm/win_calculator_v1_{1+int(epoch/50)}_mlt_pbshomma_even.pth')
#         torch.save(t_calculator.calPrioModel.state_dict(),f'data/lstm/t_calculator_v1_{1+int(epoch/50)}_mlt_pbshomma_even.pth')

#         np.save(f'data/lstm/totalEpochRewards_lstm_v1_{1+int(epoch/50)}_mlt_pbshomma_even.npy',totalEpochRewards)
#         np.save(f'data/lstm/totalAcc_lstm_v1_{1+int(epoch/50)}_mlt_pbshomma_even.npy',totalAcc)
        

# torch.save(lightService.lightServiceModel.state_dict(),'data/lstm/lightService_lstm_v1_mlt_pbshomma_even.pth')
# torch.save(tempService.tempServiceModel.state_dict(),'data/lstm/tempService_lstm_v1_mlt_pbshomma_even.pth')
# torch.save(airService.airServiceModel.state_dict(),'data/lstm/airService_lstm_v1_mlt_pbshomma_even.pth')
# torch.save(cur_calculator.calPrioModel.state_dict(),'data/lstm/cur_calculator_v1_mlt_pbshomma_even.pth')
# torch.save(win_calculator.calPrioModel.state_dict(),'data/lstm/win_calculator_v1_mlt_pbshomma_even.pth')
# torch.save(t_calculator.calPrioModel.state_dict(),'data/lstm/t_calculator_v1_mlt_pbshomma_even.pth')

# np.save(f'data/lstm/totalEpochRewards_lstm_v1_mlt_pbshomma_even.npy',totalEpochRewards)
# np.save(f'data/lstm/totalAcc_lstm_v1_mlt_pbshomma_even.npy',totalAcc)

print(f'100 acc: {np.average(totalAcc,axis=0)}')

np.save(f'./../../data/totalAcc_lstm_v1_mlt_pbshomma_even_100.npy',totalAcc)
np.save(f'./../../data/replayMemory_light_lstm_v1_mlt_pbshomma_even_100.npy',lightService.replayMemory)
np.save(f'./../../data/replayMemory_temp_lstm_v1_mlt_pbshomma_even_100.npy',tempService.replayMemory)
np.save(f'./../../data/replayMemory_air_lstm_v1_mlt_pbshomma_even_100.npy',airService.replayMemory)
