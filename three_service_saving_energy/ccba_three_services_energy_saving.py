...
# %%   
    ...
    if epoch%50==0 and epoch!=0:      
        torch.save(lightService.lightServiceModel.state_dict(),f'data/lstm/lightService_lstm_v1_{1+int(epoch/50)}_multi_cabshomma_even.pth')
        torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v1_{1+int(epoch/50)}_multi_cabshomma_even.pth')
        torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v1_{1+int(epoch/50)}_multi_cabshomma_even.pth')
        torch.save(commonService.commonServiceModel.state_dict(), f'data/lstm/commonService_lstm_v1_{1+int(epoch/50)}_multi_cabshomma_even.pth')
        np.save(f'data/lstm/totalEpochRewards_lstm_v1_{1+int(epoch/50)}_multi_cabshomma_even.npy',totalEpochRewards)
        np.save(f'data/lstm/totalAcc_lstm_v1_{1+int(epoch/50)}_multi_cabshomma_even.npy',totalAcc)
...
np.save(f'data/lstm/totalAcc_lstm_v1_multi_cabshomma_even.npy',totalAcc)
