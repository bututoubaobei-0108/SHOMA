...
from LSTM_LIGHT_SERVICE_8_CELL_NEW import *
...
lightService.lightServiceModel.load_state_dict(torch.load('./../../data/lightService_lstm_v1_7_eishomma_even_new.pth'))
lightService.targetLightServiceModel.load_state_dict(torch.load('./../../data/lightService_lstm_v1_7_eishomma_even_new.pth'))

tempService=TempService_cell()
tempService.tempServiceModel.load_state_dict(torch.load('./../../data/tempService_lstm_v1_7_eishomma_even_new.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('./../../data/tempService_lstm_v1_7_eishomma_even_new.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('./../../data/airService_lstm_v1_7_eishomma_even_new.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('./../../data/airService_lstm_v1_7_eishomma_even_new.pth'))
...
# %%   
    ...
    for step in range(0,steps):
        ...
        # print(f'totalAcc: {totalAcc[epoch,:]}')
        
        print(f'epoch:{epoch}, step:{step}, light:{light_reward_t}, temp:{temp_reward_t}, air:{air_reward_t}, totalEpochRewards:{totalEpochRewards[epoch,:]}')
...
#         torch.save(lightService.lightServiceModel.state_dict(),f'data/lstm/lightService_lstm_v1_{1+int(epoch/50)}_eishomma_even_new.pth')
#         torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v1_{1+int(epoch/50)}_eishomma_even_new.pth')
#         torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v1_{1+int(epoch/50)}_eishomma_even_new.pth')

#         np.save(f'data/lstm/totalEpochRewards_lstm_v1_{1+int(epoch/50)}_eishomma_even_new.npy',totalEpochRewards)
#         np.save(f'data/lstm/totalAcc_lstm_v1_{1+int(epoch/50)}_eishomma_even_new.npy',totalAcc)
        

# torch.save(lightService.lightServiceModel.state_dict(),'data/lstm/lightService_lstm_v1_eishomma_even_new.pth')
# torch.save(tempService.tempServiceModel.state_dict(),'data/lstm/tempService_lstm_v1_eishomma_even_new.pth')
# torch.save(airService.airServiceModel.state_dict(),'data/lstm/airService_lstm_v1_eishomma_even_new.pth')

# np.save(f'data/lstm/totalEpochRewards_lstm_v1_eishomma_even_new.npy',totalEpochRewards)
# np.save(f'data/lstm/totalAcc_lstm_v1_eishomma_even_new.npy',totalAcc)

print(f'100 acc: {np.average(totalAcc,axis=0)}')

np.save(f'./../../data/totalAcc_lstm_v1_eishomma_even_new_100.npy',totalAcc)
np.save(f'./../../data/replayMemory_light_lstm_v1_eishomma_even_new_100.npy',lightService.replayMemory)
np.save(f'./../../data/replayMemory_temp_lstm_v1_eishomma_even_new_100.npy',tempService.replayMemory)
np.save(f'./../../data/replayMemory_air_lstm_v1_eishomma_even_new_100.npy',airService.replayMemory)
