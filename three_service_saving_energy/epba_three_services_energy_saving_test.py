...
lightService.lightServiceModel.load_state_dict(torch.load('data/lstm/lightService_lstm_v1_7_eishomma_even_new.pth'))
lightService.targetLightServiceModel.load_state_dict(torch.load('data/lstm/lightService_lstm_v1_7_eishomma_even_new.pth'))

tempService=TempService_cell()
tempService.tempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_7_eishomma_even_new.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_7_eishomma_even_new.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_7_eishomma_even_new.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_7_eishomma_even_new.pth'))
...
np.save(f'data/lstm/totalAcc_lstm_v1_eishomma_even_new_100.npy',totalAcc)
np.save(f'data/lstm/replayMemory_light_lstm_v1_eishomma_even_new_100.npy',lightService.replayMemory)
np.save(f'data/lstm/replayMemory_temp_lstm_v1_eishomma_even_new_100.npy',tempService.replayMemory)
np.save(f'data/lstm/replayMemory_air_lstm_v1_eishomma_even_new_100.npy',airService.replayMemory)
