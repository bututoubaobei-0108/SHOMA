...
tempService.tempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_6_temp_air_pbshomma_noeco_even.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_6_temp_air_pbshomma_noeco_even.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_6_temp_air_pbshomma_noeco_even.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_6_temp_air_pbshomma_noeco_even.pth'))

cur_calculator=CalculationPriorities_cell(num_inputs=X_US.shape[1]+1+1,num_outputs=2)
cur_calculator.calPrioModel.load_state_dict(torch.load('data/lstm/cur_calculator_v1_6_temp_air_pbshomma_noeco_even.pth'))
cur_calculator.targetCalPrioModel.load_state_dict(torch.load('data/lstm/cur_calculator_v1_6_temp_air_pbshomma_noeco_even.pth'))

win_calculator=CalculationPriorities_cell(num_inputs=X_US.shape[1]+1+1,num_outputs=2)
win_calculator.calPrioModel.load_state_dict(torch.load('data/lstm/win_calculator_v1_6_temp_air_pbshomma_noeco_even.pth'))
win_calculator.targetCalPrioModel.load_state_dict(torch.load('data/lstm/win_calculator_v1_6_temp_air_pbshomma_noeco_even.pth'))

t_calculator=CalculationPriorities_cell(num_inputs=X_US.shape[1]+1+1,num_outputs=2)
t_calculator.calPrioModel.load_state_dict(torch.load('data/lstm/t_calculator_v1_6_temp_air_pbshomma_noeco_even.pth'))
t_calculator.targetCalPrioModel.load_state_dict(torch.load('data/lstm/t_calculator_v1_6_temp_air_pbshomma_noeco_even.pth'))
...
# %%   
    ...
    if epoch%50==0 and epoch!=0:      
        ...
        torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v1_{6+int(epoch/50)}_temp_air_pbshomma_noeco_even.pth')
        torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v1_{6+int(epoch/50)}_temp_air_pbshomma_noeco_even.pth')

        torch.save(cur_calculator.calPrioModel.state_dict(),f'data/lstm/cur_calculator_v1_{6+int(epoch/50)}_temp_air_pbshomma_noeco_even.pth')
        torch.save(win_calculator.calPrioModel.state_dict(),f'data/lstm/win_calculator_v1_{6+int(epoch/50)}_temp_air_pbshomma_noeco_even.pth')
        torch.save(t_calculator.calPrioModel.state_dict(),f'data/lstm/t_calculator_v1_{6+int(epoch/50)}_temp_air_pbshomma_noeco_even.pth')

        np.save(f'data/lstm/totalEpochRewards_lstm_v1_{6+int(epoch/50)}_temp_air_pbshomma_noeco_even.npy',totalEpochRewards)
