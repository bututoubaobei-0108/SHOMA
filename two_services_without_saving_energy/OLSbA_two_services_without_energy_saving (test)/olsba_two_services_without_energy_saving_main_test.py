...
MultiService.multiServiceModel.load_state_dict(torch.load('./../../data/multiService_lstm_v1_temp_air_olbshomma_noeco_even.pth'))
MultiService.targetMultiServiceModel.load_state_dict(torch.load('./../../data/multiService_lstm_v1_temp_air_olbshomma_noeco_even.pth'))
# %%
...
np.save(f'./../../data/totalAcc_multiService_totalEpochRewards_lstm_v1_temp_air_olbshomma_noeco_even_100.npy',totalAcc) 
        
np.save(f'./../../data/replayMemory_MultiService_lstm_v1_temp_air_olbshomma_noeco_even_100.npy',MultiService.replayMemory)
