...
tempService.tempServiceModel.load_state_dict(torch.load('./../../data/tempService_lstm_v1_temp_air_eishomma_noeco_even.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('./../../data/tempService_lstm_v1_temp_air_eishomma_noeco_even.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('./../../data/airService_lstm_v1_temp_air_eishomma_noeco_even.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('./../../data/airService_lstm_v1_temp_air_eishomma_noeco_even.pth'))
...
# %%   
    ...
    for step in range(0,steps):
        ...
        if temp_reward>0:
            num_corr_temp+=1
            # totalAcc[epoch,0]=num_corr_temp

        print(f'num_corr_temp: {num_corr_temp}')

        if air_reward>0:
            num_corr_air+=1
            # totalAcc[epoch,1]=num_corr_air
    ...
    #     torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v1_{1+int(epoch/200)}_temp_air_eishomma_noeco_even.pth')
    #     torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v1_{1+int(epoch/200)}_temp_air_eishomma_noeco_even.pth')

    #     np.save(f'data/lstm/totalEpochRewards_lstm_v1_{1+int(epoch/200)}_temp_air_eishomma_noeco_even.npy',totalEpochRewards)

    #     np.save(f'data/lstm/replayMemory_temp_lstm_v1_{1+int(epoch/200)}_temp_air_eishomma_noeco_even.npy',tempService.replayMemory)
    #     np.save(f'data/lstm/replayMemory_air_lstm_v1_{1+int(epoch/200)}_temp_air_eishomma_noeco_even.npy',airService.replayMemory)

        

# torch.save(lightService.lightServiceModel.state_dict(),'data/lstm/lightService_lstm_v1_eishomma_even.pth')
# torch.save(tempService.tempServiceModel.state_dict(),'data/lstm/tempService_lstm_v1_temp_air_eishomma_noeco_even.pth')
# torch.save(airService.airServiceModel.state_dict(),'data/lstm/airService_lstm_v1_temp_air_eishomma_noeco_even.pth')

# np.save(f'data/lstm/totalEpochRewards_lstm_v1_temp_air_eishomma_noeco_even.npy',totalEpochRewards)

# np.save(f'data/lstm/replayMemory_temp_lstm_v1_temp_air_eishomma_noeco_even.npy',tempService.replayMemory)
# np.save(f'data/lstm/replayMemory_air_lstm_v1_temp_air_eishomma_noeco_even.npy',airService.replayMemory)
        
print(f'100 acc: {np.average(totalAcc,axis=0)}')  
np.save(f'./../../data/totalAcc_lstm_v1_temp_air_eishomma_noeco_even_100.npy',totalAcc) 
        
np.save(f'./../../data/replayMemory_temp_lstm_v1_temp_air_eishomma_noeco_even_100.npy',tempService.replayMemory)
np.save(f'./../../data/replayMemory_air_lstm_v1_temp_air_eishomma_noeco_even_100.npy',airService.replayMemory)
