...
torch.save(tempService.tempServiceModel.state_dict(),'./../../data/tempService_lstm_v1_temp_air_eishomma_noeco_even.pth')
torch.save(airService.airServiceModel.state_dict(),'./../../data/airService_lstm_v1_temp_air_eishomma_noeco_even.pth')

np.save(f'./../../data/totalEpochRewards_lstm_v1_temp_air_eishomma_noeco_even.npy',totalEpochRewards)

np.save(f'./../../data/replayMemory_temp_lstm_v1_temp_air_eishomma_noeco_even.npy',tempService.replayMemory)
np.save(f'./../../data/replayMemory_air_lstm_v1_temp_air_eishomma_noeco_even.npy',airService.replayMemory)
