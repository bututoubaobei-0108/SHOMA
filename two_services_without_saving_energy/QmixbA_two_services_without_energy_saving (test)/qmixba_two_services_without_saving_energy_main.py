...
# %%
    ...
    if epoch%200==0 and epoch!=0:      
        ...
        torch.save(qmix_sho_agent.temp_service.agents.state_dict(),f'./../../data/tempService_lstm_v1_{1+int(epoch/200)}_temp_air_qmixshomma_3_noeco.pth')
        torch.save(qmix_sho_agent.air_service.agents.state_dict(),f'./../../data/airService_lstm_v1_{1+int(epoch/200)}_temp_air_qmixshomma_3_noeco.pth')
        ...
        torch.save(qmix_sho_agent.qmixer.state_dict(), f'./../../data/qmixer_lstm_v1_{1+int(epoch/200)}_temp_air_qmixshomma_3_noeco.pth')

        np.save(f'./../../data/totalEpochRewards_lstm_v1_{1+int(epoch/200)}_temp_air_qmixshomma_3_noeco.npy',totalEpochRewards)
        

# torch.save(qmix_sho_agent.light_service.agents.state_dict(),f'data/lstm/lightService_lstm_v1_mlt_qmix.pth')
torch.save(qmix_sho_agent.temp_service.agents.state_dict(),f'./../../data/tempService_lstm_v1_temp_air_qmixshomma_3_noeco.pth')
torch.save(qmix_sho_agent.air_service.agents.state_dict(),f'./../../data/airService_lstm_v1_temp_air_qmixshomma_3_noeco.pth')
# torch.save(qmix_sho_agent.common_service.agents.state_dict(),f'data/lstm/commonService_lstm_v1_mlt_qmix.pth')
torch.save(qmix_sho_agent.qmixer.state_dict(), f'./../../data/qmixer_lstm_v1_temp_air_qmixshomma_3_noeco.pth')

np.save(f'./../../data/totalEpochRewards_lstm_v1_temp_air_qmixshomma_3_noeco.npy',totalEpochRewards)
