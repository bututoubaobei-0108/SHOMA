...
qmix_sho_agent.temp_service.agents.load_state_dict(torch.load('./../../data/tempService_lstm_v1_temp_air_qmixshomma_3_noeco.pth'))
qmix_sho_agent.air_service.agents.load_state_dict(torch.load('./../../data/airService_lstm_v1_temp_air_qmixshomma_3_noeco.pth'))
qmix_sho_agent.qmixer.load_state_dict(torch.load('./../../data/qmixer_lstm_v1_temp_air_qmixshomma_3_noeco.pth'))
...
np.save(f'./../../data/totalAcc_lstm_v1_temp_air_qmixshomma_3_noeco_100.npy',totalAcc) 
        
np.save(f'./../../data/replayMemory_qmix_sho_agent_lstm_v1_temp_air_qmixshomma_3_noeco_100.npy',qmix_sho_agent.replayMemory)
