...
# tempService.tempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_58_mlt.pth'))
# tempService.targetTempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_58_mlt.pth'))

airService=AirService_cell()
# airService.airServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_58_mlt.pth'))
# airService.targetAirServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_58_mlt.pth'))
...
totalAcc=np.full([num_epochs,2],0)
