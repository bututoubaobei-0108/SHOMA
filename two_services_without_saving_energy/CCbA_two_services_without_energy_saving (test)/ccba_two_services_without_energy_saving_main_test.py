...
MultiService.multiServiceModel.load_state_dict(torch.load('./../../data/MultiService_lstm_v1_3_temp_air_cbshomma_noeco_even.pth'))
MultiService.targetMultiServiceModel.load_state_dict(torch.load('./../../data/MultiService_lstm_v1_3_temp_air_cbshomma_noeco_even.pth'))
...
np.save(f'./../../data/totalAcc_multiService_totalEpochRewards_lstm_v1_temp_air_cbshomma_noeco_even_100.npy',totalAcc) 
        
np.save(f'./../../data/replayMemory_temp_lstm_v1_temp_air_cbshomma_noeco_even_100.npy',tempService.replayMemory)
np.save(f'./../../data/replayMemory_air_lstm_v1_temp_air_cbshomma_noeco_even_100.npy',airService.replayMemory)
