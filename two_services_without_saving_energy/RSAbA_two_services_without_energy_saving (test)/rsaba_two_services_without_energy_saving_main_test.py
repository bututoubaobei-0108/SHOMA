...
tempService.tempServiceModel.load_state_dict(torch.load('./../../data/tempService_lstm_v1_temp_air_eishomma_1.0_noeco_even.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('./../../data/tempService_lstm_v1_temp_air_eishomma_1.0_noeco_even.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('./../../data/airService_lstm_v1_temp_air_eishomma_1.0_noeco_even.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('./../../data/airService_lstm_v1_temp_air_eishomma_1.0_noeco_even.pth'))
...
#         # torch.save(lightService.lightServiceModel.state_dict(),f'data/lstm/lightService_lstm_v1_{1+int(epoch/100)}_mlt_22.pth')
#         torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v1_{1+int(epoch/200)}_temp_air_eishomma_1.0_noeco_even.pth')
#         torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v1_{1+int(epoch/200)}_temp_air_eishomma_1.0_noeco_even.pth')
#         np.save(f'data/lstm/totalEpochRewards_lstm_v1_{1+int(epoch/200)}_temp_air_eishomma_1.0_noeco_even.npy',totalEpochRewards)
        

# # torch.save(lightService.lightServiceModel.state_dict(),'data/lstm/lightService_lstm_v1_temp_air_eishomma_1.0_even.pth')
# torch.save(tempService.tempServiceModel.state_dict(),'data/lstm/tempService_lstm_v1_temp_air_eishomma_1.0_noeco_even.pth')
# torch.save(airService.airServiceModel.state_dict(),'data/lstm/airService_lstm_v1_temp_air_eishomma_1.0_noeco_even.pth')
# np.save(f'data/lstm/totalEpochRewards_lstm_v1_temp_air_eishomma_1.0_noeco_even.npy',totalEpochRewards)

print(f'100 acc: {np.average(totalAcc,axis=0)}')  
np.save(f'./../../data/totalAcc_lstm_v1_temp_air_eishomma_1.0_noeco_even_100.npy',totalAcc) 
        
np.save(f'./../../data/replayMemory_temp_lstm_v1_temp_air_eishomma_1.0_noeco_even_100.npy',tempService.replayMemory)
np.save(f'./../../data/replayMemory_air_lstm_v1_temp_air_eishomma_1.0_noeco_even_100.npy',airService.replayMemory)
...
# tempR=np.load(f'data/lstm/replayMemory_temp_lstm_v1_temp_air_eishomma_1.0_noeco_even_100.npy',allow_pickle=True)
# airR=np.load(f'data/lstm/replayMemory_air_lstm_v1_temp_air_eishomma_1.0_noeco_even_100.npy',allow_pickle=True)


# totalAcc=np.full([100,4],0)


# for epoch in range(100*288):

#     print(f'epoch: {epoch}')

#     if tempR[epoch,-2]>0:

#         totalAcc[int(epoch/288),1]+=1

#     print(f'num_corr_temp: {totalAcc[int(epoch/288),1]}')

#     if airR[epoch,-2]>0:
#         totalAcc[int(epoch/288),2]+=1

#     print(f'num_corr_air: {totalAcc[int(epoch/288),2]}')

#     if tempR[epoch,-2]>0 and airR[epoch,-2]>0:

#         totalAcc[int(epoch/288),3]+=1

#     print(f'three corr: {totalAcc[int(epoch/288),3]}')
