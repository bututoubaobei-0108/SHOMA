...
tempService.tempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_3_temp_air_eishomma_2.0_noeco_even.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_3_temp_air_eishomma_2.0_noeco_even.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_3_temp_air_eishomma_2.0_noeco_even.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_3_temp_air_eishomma_2.0_noeco_even.pth'))
...
# %%   
    ...
    if epoch%200==0 and epoch!=0:      
        ...
        torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v1_{1+3+int(epoch/200)}_temp_air_eishomma_2.0_noeco_even.pth')
        torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v1_{1+3+int(epoch/200)}_temp_air_eishomma_2.0_noeco_even.pth')

        np.save(f'data/lstm/totalEpochRewards_lstm_v1_{1+3+int(epoch/200)}_temp_air_eishomma_2.0_noeco_even.npy',totalEpochRewards)
...
np.save(f'data/lstm/totalAcc_lstm_v1_temp_air_eishomma_2.0_noeco_even.npy',totalAcc)
