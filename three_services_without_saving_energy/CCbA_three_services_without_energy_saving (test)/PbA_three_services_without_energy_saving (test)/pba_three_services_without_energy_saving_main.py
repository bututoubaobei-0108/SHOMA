...
# %%   
    ...
    if epoch%50==0 and epoch!=0:      
        torch.save(lightService.lightServiceModel.state_dict(),f'./../../data/lightService_lstm_v1_{17+int(epoch/50)}_mlt_pbshomma_noeco_even.pth')
        torch.save(tempService.tempServiceModel.state_dict(),f'./../../data/tempService_lstm_v1_{17+int(epoch/50)}_mlt_pbshomma_noeco_even.pth')
        torch.save(airService.airServiceModel.state_dict(),f'./../../data/airService_lstm_v1_{17+int(epoch/50)}_mlt_pbshomma_noeco_even.pth')

        torch.save(cur_calculator.calPrioModel.state_dict(),f'./../../data/cur_calculator_v1_{17+int(epoch/50)}_mlt_pbshomma_noeco_even.pth')
        torch.save(win_calculator.calPrioModel.state_dict(),f'./../../data/win_calculator_v1_{17+int(epoch/50)}_mlt_pbshomma_noeco_even.pth')
        torch.save(t_calculator.calPrioModel.state_dict(),f'./../../data/t_calculator_v1_{17+int(epoch/50)}_mlt_pbshomma_noeco_even.pth')

        np.save(f'./../../data/totalEpochRewards_lstm_v1_{17+int(epoch/50)}_mlt_pbshomma_noeco_even.npy',totalEpochRewards)
        np.save(f'./../../data/totalAcc_lstm_v1_{17+int(epoch/50)}_mlt_pbshomma_noeco_even.npy',totalAcc)
        

torch.save(lightService.lightServiceModel.state_dict(),'./../../data/lightService_lstm_v1_mlt_pbshomma_noeco_even.pth')
torch.save(tempService.tempServiceModel.state_dict(),'./../../data/tempService_lstm_v1_mlt_pbshomma_noeco_even.pth')
torch.save(airService.airServiceModel.state_dict(),'./../../data/airService_lstm_v1_mlt_pbshomma_noeco_even.pth')
torch.save(cur_calculator.calPrioModel.state_dict(),'./../../data/cur_calculator_v1_mlt_pbshomma_noeco_even.pth')
torch.save(win_calculator.calPrioModel.state_dict(),'./../../data/win_calculator_v1_mlt_pbshomma_noeco_even.pth')
torch.save(t_calculator.calPrioModel.state_dict(),'./../../data/t_calculator_v1_mlt_pbshomma_noeco_even.pth')

np.save(f'./../../data/totalEpochRewards_lstm_v1_mlt_pbshomma_noeco_even.npy',totalEpochRewards)
np.save(f'./../../data/totalAcc_lstm_v1_mlt_pbshomma_noeco_even.npy',totalAcc)
