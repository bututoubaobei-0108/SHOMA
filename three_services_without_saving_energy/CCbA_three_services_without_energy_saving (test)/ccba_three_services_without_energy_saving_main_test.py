...
from LSTM_LIGHT_SERVICE_CABSHOMMA_NOECO_CELL import *
from LSTM_AIR_SERVICE_CABSHOMMA_NOECO_CELL import *
from LSTM_TEMP_SERVICE_CABSHOMMA_NOECO_CELL import *
from Common_SERVICE_CABSHOMMA_CELL import *
...
lightService.lightServiceModel.load_state_dict(torch.load('./../../data/lightService_lstm_v1_multi_cabshomma_noeco_even.pth'))
lightService.targetLightServiceModel.load_state_dict(torch.load('./../../data/lightService_lstm_v1_multi_cabshomma_noeco_even.pth'))

tempService=TempService_cell()
tempService.tempServiceModel.load_state_dict(torch.load('./../../data/tempService_lstm_v1_multi_cabshomma_noeco_even.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('./../../data/tempService_lstm_v1_multi_cabshomma_noeco_even.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('./../../data/airService_lstm_v1_multi_cabshomma_noeco_even.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('./../../data/airService_lstm_v1_multi_cabshomma_noeco_even.pth'))

commonService=CommonService_cell()
commonService.commonServiceModel.load_state_dict(torch.load('./../../data/commonService_lstm_v1_multi_cabshomma_noeco_even.pth'))
commonService.targetCommonServiceModel.load_state_dict(torch.load('./../../data/commonService_lstm_v1_multi_cabshomma_noeco_even.pth'))
...
totalEpochRewards=np.full([num_epochs,4],0)
...
# %%   
    ...
    for step in range(0,steps):
        ...
        commonService.setStates(x_us_t, x_ar_t, x_ae_t, x_ap_t, x_win_t, x_cur_t, x_tr_t, x_te_t, x_at_t, x_et_t, MAX_CO2, MAX_LE, MAX_TEMP)
        ...
        x_common_t_norm=torch.cat((x_us_t_norm,x_te_t_norm,x_tr_t_norm,x_ae_t_norm,x_ar_t_norm),axis=1)
        ...
        if sigma>0.1:
            ...
            Q_light_ls_t=lightService.getActions(x_light_t_norm)
            Q_temp_ac_t,Q_temp_tt_t=tempService.getActions(x_temp_t_norm)
            Q_air_ap_t,Q_air_at_t=airService.getActions(x_air_t_norm)
            Q_common_cur_t, Q_common_win_t, Q_common_et_t=commonService.getActions(x_common_t_norm)
            ...
            idx_x_cur_t_new=(torch.max(Q_common_cur_t,dim=1,keepdim=True)[1]).to(device)
            ...
            idx_x_win_t_new=(torch.max(Q_common_win_t,dim=1,keepdim=True)[1]).to(device)
            ...
            idx_x_et_t_new=(torch.max(Q_common_et_t,dim=1,keepdim=True)[1]).to(device)
        ...
        x_common_t_new_norm=torch.cat((x_us_t_new_norm,x_te_t_new_norm,x_tr_t_new_norm,x_ae_t_new_norm,x_ar_t_new_norm),axis=1)
        ...
        common_actions=(x_cur_t_new,x_win_t_new,x_et_t_new)
        ...
        commonService.setStates(x_us_t_new, x_ar_t_new, x_ae_t_new, x_ap_t_new, x_win_t_new, x_cur_t_new, x_tr_t_new, x_te_t_new, x_at_t_new, x_et_t_new, MAX_CO2,MAX_LE, MAX_TEMP)
        ...
        common_reward=(temp_reward+air_reward)/2
        common_reward_t=torch.tensor([[common_reward]],dtype=torch.float32,device=device)
        ...
        totalEpochRewards[epoch,3]+=common_reward
        ...
        common_transition=(x_common_t_norm, common_actions,common_reward_t,x_common_t_new_norm)
        ...
        commonService.updateReplayMemory(common_transition)
...
#         commonService.targetCommonServiceModel.load_state_dict(commonService.commonServiceModel.state_dict())
             
#     if epoch%200==0 and epoch!=0:      
#         torch.save(lightService.lightServiceModel.state_dict(),f'data/lstm/lightService_lstm_v1_{1+int(epoch/200)}_multi_cabshomma_noeco_even.pth')
#         torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v1_{1+int(epoch/200)}_multi_cabshomma_noeco_even.pth')
#         torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v1_{1+int(epoch/200)}_multi_cabshomma_noeco_even.pth')
#         torch.save(commonService.commonServiceModel.state_dict(), f'data/lstm/commonService_lstm_v1_{1+int(epoch/200)}_multi_cabshomma_noeco_even.pth')
#         np.save(f'data/lstm/totalEpochRewards_lstm_v1_{1+int(epoch/200)}_multi_cabshomma_noeco_even.npy',totalEpochRewards)
        

# torch.save(lightService.lightServiceModel.state_dict(),'data/lstm/lightService_lstm_v1_multi_cabshomma_noeco_even.pth')
# torch.save(tempService.tempServiceModel.state_dict(),'data/lstm/tempService_lstm_v1_multi_cabshomma_noeco_even.pth')
# torch.save(airService.airServiceModel.state_dict(),'data/lstm/airService_lstm_v1_multi_cabshomma_noeco_even.pth')
# torch.save(commonService.commonServiceModel.state_dict(), f'data/lstm/commonService_lstm_v1_multi_cabshomma_noeco_even.pth')
# np.save(f'data/lstm/totalEpochRewards_lstm_v1_multi_cabshomma_noeco_even.npy',totalEpochRewards)

print(f'100 acc: {np.average(totalAcc,axis=0)}')

np.save(f'./../../data/totalAcc_lstm_v1_multi_cabshomma_noeco_even_100.npy',totalAcc)
np.save(f'./../../data/replayMemory_light_lstm_v1_multi_cabshomma_noeco_even_100.npy',lightService.replayMemory)
np.save(f'./../../data/replayMemory_temp_lstm_v1_multi_cabshomma_noeco_even_100.npy',tempService.replayMemory)
np.save(f'./../../data/replayMemory_air_lstm_v1_multi_cabshomma_noeco_even_100.npy',airService.replayMemory)
