...
class TempService_cell:
    ...
    def getActions(self,X_t_norm):
        ...
        Q_ac_t=Q[:,:len(X_AC[0])].reshape(1,-1)
        
        Q_t_t=Q[:,len(X_AC[0]):].reshape(1,-1)
    ...
    def train(self,epoch):
        ...
        q_ac_list_t=q_list_t[:,:len(X_AC[0])]
      
        q_t_list_t=q_list_t[:,len(X_AC[0]):]
        ...
        q_ac_list_t_plus_1=q_list_t_plus_1[:,:len(X_AC[0])]
        
        q_t_list_t_plus_1=q_list_t_plus_1[:,len(X_AC[0]):]
