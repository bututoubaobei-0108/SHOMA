...
# %%  
    ...
    if epoch%200==0 and epoch!=0:      
        torch.save(lightService.lightServiceModel.state_dict(),f'./../../data/lightService_lstm_v1_{1+5+int(epoch/100)}_eishomma_1.0_noeco_even.pth')
        torch.save(tempService.tempServiceModel.state_dict(),f'./../../data/tempService_lstm_v1_{1+5+int(epoch/200)}_eishomma_1.0_noeco_even.pth')
        torch.save(airService.airServiceModel.state_dict(),f'./../../data/airService_lstm_v1_{1+5+int(epoch/200)}_eishomma_1.0_noeco_even.pth')
        np.save(f'./../../data/totalEpochRewards_lstm_v1_{1+5+int(epoch/200)}_eishomma_1.0_noeco_even.npy',totalEpochRewards)
        

torch.save(lightService.lightServiceModel.state_dict(),'./../../data/lightService_lstm_v1_eishomma_1.0_noeco_even.pth')
torch.save(tempService.tempServiceModel.state_dict(),'./../../data/tempService_lstm_v1_eishomma_1.0_noeco_even.pth')
torch.save(airService.airServiceModel.state_dict(),'./../../data/airService_lstm_v1_eishomma_1.0_noeco_even.pth')
np.save(f'./../../data/totalEpochRewards_lstm_v1_eishomma_1.0_noeco_even.npy',totalEpochRewards)
