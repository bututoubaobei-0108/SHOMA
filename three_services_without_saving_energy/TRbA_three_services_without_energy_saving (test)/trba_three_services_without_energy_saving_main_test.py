...
lightService.lightServiceModel.load_state_dict(torch.load('./../../data/lightService_lstm_v1_17_eishomma_2.0_noeco_even.pth'))
lightService.targetLightServiceModel.load_state_dict(torch.load('./../../data/lightService_lstm_v1_17_eishomma_2.0_noeco_even.pth'))

tempService=TempService_cell()
tempService.tempServiceModel.load_state_dict(torch.load('./../../data/tempService_lstm_v1_17_eishomma_2.0_noeco_even.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('./../../data/tempService_lstm_v1_17_eishomma_2.0_noeco_even.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('./../../data/airService_lstm_v1_17_eishomma_2.0_noeco_even.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('./../../data/airService_lstm_v1_17_eishomma_2.0_noeco_even.pth'))
...
# %%  
    ...
    for step in range(0,steps):
        ...
        two_reward_t=temp_reward_t+air_reward_t+light_reward

        # print(f'totalEpochRewards: {totalEpochRewards[epoch,:]}')
        
        # calculate the transitions
        light_transition=(x_light_t_norm,light_actions,light_reward_t+two_reward_t,x_light_t_new_norm)
        temp_transition=(x_temp_t_norm,temp_actions,temp_reward_t+two_reward_t,x_temp_t_new_norm)
        air_transition=(x_air_t_norm, air_actions, air_reward_t+two_reward_t,x_air_t_new_norm)
...
#         torch.save(lightService.lightServiceModel.state_dict(),f'data/lstm/lightService_lstm_v1_{1+int(epoch/50)}_eishomma_2.0_noeco_even.pth')
#         torch.save(tempService.tempServiceModel.state_dict(),f'data/lstm/tempService_lstm_v1_{1+int(epoch/50)}_eishomma_2.0_noeco_even.pth')
#         torch.save(airService.airServiceModel.state_dict(),f'data/lstm/airService_lstm_v1_{1+int(epoch/50)}_eishomma_2.0_noeco_even.pth')

#         np.save(f'data/lstm/totalEpochRewards_lstm_v1_{1+int(epoch/50)}_eishomma_2.0_noeco_even.npy',totalEpochRewards)
#         np.save(f'data/lstm/totalAcc_lstm_v1_{1+int(epoch/50)}_eishomma_2.0_noeco_even.npy',totalAcc)
        

# torch.save(lightService.lightServiceModel.state_dict(),'data/lstm/lightService_lstm_v1_eishomma_2.0_noeco_even.pth')
# torch.save(tempService.tempServiceModel.state_dict(),'data/lstm/tempService_lstm_v1_eishomma_2.0_noeco_even.pth')
# torch.save(airService.airServiceModel.state_dict(),'data/lstm/airService_lstm_v1_eishomma_2.0_noeco_even.pth')

# np.save(f'data/lstm/totalEpochRewards_lstm_v1_eishomma_2.0_noeco_even.npy',totalEpochRewards)
# np.save(f'data/lstm/totalAcc_lstm_v1_eishomma_2.0_noeco_even.npy',totalAcc)

print(f'100 acc: {np.average(totalAcc,axis=0)}')

np.save(f'./../../data/totalAcc_lstm_v1_eishomma_2.0_noeco_even_100.npy',totalAcc)
np.save(f'./../../data/replayMemory_light_lstm_v1_eishomma_2.0_noeco_even_100.npy',lightService.replayMemory)
np.save(f'./../../data/replayMemory_temp_lstm_v1_eishomma_2.0_noeco_even_100.npy',tempService.replayMemory)
np.save(f'./../../data/replayMemory_air_lstm_v1_eishomma_2.0_noeco_even_100.npy',airService.replayMemory)
