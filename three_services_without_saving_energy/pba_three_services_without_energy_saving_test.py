...
lightService.lightServiceModel.load_state_dict(torch.load('data/lstm/lightService_lstm_v1_25_mlt_pbshomma_noeco_even.pth'))
lightService.targetLightServiceModel.load_state_dict(torch.load('data/lstm/lightService_lstm_v1_25_mlt_pbshomma_noeco_even.pth'))

tempService=TempService_cell()
tempService.tempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_25_mlt_pbshomma_noeco_even.pth'))
tempService.targetTempServiceModel.load_state_dict(torch.load('data/lstm/tempService_lstm_v1_25_mlt_pbshomma_noeco_even.pth'))

airService=AirService_cell()
airService.airServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_25_mlt_pbshomma_noeco_even.pth'))
airService.targetAirServiceModel.load_state_dict(torch.load('data/lstm/airService_lstm_v1_25_mlt_pbshomma_noeco_even.pth'))

cur_calculator=CalculationPriorities_cell(num_inputs=X_US.shape[1]+1+1+1,num_outputs=3)
cur_calculator.calPrioModel.load_state_dict(torch.load('data/lstm/cur_calculator_v1_25_mlt_pbshomma_noeco_even.pth'))
cur_calculator.targetCalPrioModel.load_state_dict(torch.load('data/lstm/cur_calculator_v1_25_mlt_pbshomma_noeco_even.pth'))

win_calculator=CalculationPriorities_cell(num_inputs=X_US.shape[1]+1+1,num_outputs=2)
win_calculator.calPrioModel.load_state_dict(torch.load('data/lstm/win_calculator_v1_25_mlt_pbshomma_noeco_even.pth'))
win_calculator.targetCalPrioModel.load_state_dict(torch.load('data/lstm/win_calculator_v1_25_mlt_pbshomma_noeco_even.pth'))

t_calculator=CalculationPriorities_cell(num_inputs=X_US.shape[1]+1+1,num_outputs=2)
t_calculator.calPrioModel.load_state_dict(torch.load('data/lstm/t_calculator_v1_25_mlt_pbshomma_noeco_even.pth'))
t_calculator.targetCalPrioModel.load_state_dict(torch.load('data/lstm/t_calculator_v1_25_mlt_pbshomma_noeco_even.pth'))
...
np.save(f'data/lstm/totalAcc_lstm_v1_mlt_pbshomma_noeco_even_100.npy',totalAcc)
np.save(f'data/lstm/replayMemory_light_lstm_v1_mlt_pbshomma_noeco_even_100.npy',lightService.replayMemory)
np.save(f'data/lstm/replayMemory_temp_lstm_v1_mlt_pbshomma_noeco_even_100.npy',tempService.replayMemory)
np.save(f'data/lstm/replayMemory_air_lstm_v1_mlt_pbshomma_noeco_even_100.npy',airService.replayMemory)
