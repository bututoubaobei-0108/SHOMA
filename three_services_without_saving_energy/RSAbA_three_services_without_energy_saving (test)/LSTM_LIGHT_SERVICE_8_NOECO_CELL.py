...
#         torch.save(lightService.lightServiceModel.state_dict(),f'data/lstm/lightService_light_lstm_v1_{1+int(epoch/200)}_sig_8_noeco.pth')
#         np.save(f'data/lstm/totalEpochRewards_light_lstm_v1_{1+int(epoch/200)}_sig_8_noeco.npy',totalEpochRewards)


# torch.save(lightService.lightServiceModel.state_dict(),'data/lstm/lightService_light_lstm_v1_sig_8_noeco.pth')
# np.save(f'data/lstm/totalEpochRewards_light_lstm_v1_sig_8_noeco.npy',totalEpochRewards)
#     